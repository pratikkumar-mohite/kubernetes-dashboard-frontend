...
function MyApp({ Component, pageProps }) {
  ...
  const description = "Admin Portal - template"
  const keywords = "Admin Portal, Nextjs, Next.js, Course, Sass, landing, Marketing, admin themes, Nextjs admin, Nextjs dashboard, ui kit, web app, Golang"
