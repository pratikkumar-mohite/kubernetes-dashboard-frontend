        ...
        <Card.Body>
          <div className="d-flex justify-content-between mb-5 align-items-center">
            ...
            <div className="d-flex align-items-center">
              <div>
                <Image src="/images/avatar/avatar.jpg" alt="" className="avatar avatar-md rounded-circle" />
              </div>
              <div className="ms-3">
          ...
          <Row>
            <Col xl={1} lg={2} md={2} xs={12} className="mb-3 mb-lg-0">
              <Image src="/images/avatar/avatar.jpg" className="avatar avatar-md rounded-circle" alt="" />
            </Col>
