            ...
            <Dropdown as="li" className="ms-2">
                ...
                <Dropdown.Menu
                    ...
                    <Dropdown.Item as="div" className="px-4 pb-0 pt-2" bsPrefix=' '>
                            <div className="lh-1 ">
                                <h5 className="mb-1"> Pratikkumar Mohite</h5>
                                <Link href="https://www.google.com/" className="text-inherit fs-6">View my profile</Link>
                            </div>
                            <div className=" dropdown-divider mt-3 mb-2"></div>
                    </Dropdown.Item>
                    <Dropdown.Item href="/pages/profile" eventKey="2">
                    ...
                    <Dropdown.Item href="authentication/sign-in">
